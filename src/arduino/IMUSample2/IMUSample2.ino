...
Hardware setup: This library supports communicating with the z zzx aazzzzzz
...
double headingComp = 0.0; //essentially declination compensation
...
void calibrate()
{
  ...
  float heading1 = 0.0;
  float heading2 = 0.0;
  while(sgn(heading1) == sgn(heading2))
  {
    imu.readMag();
    imu.readAccel();

    if (imu.my == 0)
      heading2 = (imu.mx < 0) ? 180.0 : 0;
    else
      heading2 = atan2(imu.mx, imu.my);

    if (heading1 == 0) heading1 = heading2;
  }
